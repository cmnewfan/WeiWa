 ...
 * [WeiboCommentFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [WeiboCommentFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class WeiboCommentFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val holder = SingleWB_ViewHolder(mView!!, this@WeiboCommentFragment, object : onAdapterEvent {
        ...
        adapter = CommentAdapter(commentPojo!!, this@WeiboCommentFragment)
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): WeiboCommentFragment {
            val fragment = WeiboCommentFragment()
            val args = Bundle()
