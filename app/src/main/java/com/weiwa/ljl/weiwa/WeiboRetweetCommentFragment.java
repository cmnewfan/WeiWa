 ...
 * {@link WeiboRetweetCommentFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link WeiboRetweetCommentFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class WeiboRetweetCommentFragment extends Fragment {
    ...
    public WeiboRetweetCommentFragment() {
    ...
    public static WeiboRetweetCommentFragment newInstance(String param1, String param2) {
        WeiboRetweetCommentFragment fragment = new WeiboRetweetCommentFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Retweeted_ViewHolder holder = new Retweeted_ViewHolder(mView,WeiboRetweetCommentFragment.this,new onAdapterEvent() {
            @Override
        ...
        },commentPojo.getStatus().getRetweeted_status().getId());
        holder.setRetweetId(commentPojo.getStatus().getId());
